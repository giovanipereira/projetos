    ...
    public partial class frmTelaConsultaProduto : Form
    {
        ...
        private void Atualizar()
        {
            if (dgvConsultaProdutos.RowCount > 0)
            {
                ...
                telaCadastroProduto = new frmTelaCadastroProduto((int)EnumOpcao.Atualizar);
                telaCadastroProduto.txtCodigo.Text = dados[0].ToString();
                telaCadastroProduto.txtNome.Text = dados[1].ToString();
                telaCadastroProduto.txtValorUnitario.Text = dados[2].ToString();
                ...
                telaCadastroProduto.txtQuantidade.Text = dados[6].ToString();
                ...
                telaCadastroProduto.controladorTelaCadastroProduto().Load((int)EnumOpcao.Atualizar);
